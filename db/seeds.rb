...
20.times do
    ...
    scope: Faker::Lorem.paragraphs(number: 3).join("/n/n"),
    ownership: Faker::Lorem.paragraphs(number: 2).join("/n/n"),
    key_knowledge_and_skills: Faker::Lorem.paragraphs(number: 4).join("/n/n"),
